...
const cliConfig = {
  ...
  help: {
    name: 'Artificial Museum staging builder',
    header: 'builds staging.artificialmuseum.com from local source.',
    options: {
...
const run = async () => {
  ...
  log.success('@artificialmuseum/staging:', 'copied all needed files')
}
